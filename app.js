/**
 * Created by Marc Freeman on 18/04/2017.
 *
...
// set some directions using vector, each lifeform will be able to move within one square of its current position!
var directions = {
    "n": new Vector(0, 1),
    "ne": new Vector(1, -1),
    "e": new Vector(1, 0),
...
// This is a helper function that selects a random element of the array
...
// World object. This will take a plan (See above) and a legend as arguments.
